...
public class UserOrder implements JsonAble {
    ...
    public UserOrder(String orderId, String fromStation, String toStation, String dates, String trains, String seats, String people, String contactInfo, int priority, Timestamp orderTime, Timestamp expireTime, String status, int queryCount, String openId) {
