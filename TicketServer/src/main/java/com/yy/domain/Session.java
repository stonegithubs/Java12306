...
public class Session implements Serializable {
    ...
    private CloseableHttpClient getClient(boolean isHttps){
    ...
    private Object get(String url, Map<String,String> headerMap, boolean isHttps){
    ...
    private Object post(String url, Map<String,String> headerMap, List<NameValuePair> nameValuePairList, boolean isHttps){
        JSONObject jsonObject;
        CloseableHttpResponse response = null;
        CloseableHttpClient client = getClient(isHttps);
        try {
